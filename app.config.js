...
exports.AUTH = {
	...
	jwtTokenSecret: argv.auth_key || 'blog-node-egg',
	defaultPassword: argv.auth_default_password || 'root',
};

exports.EMAIL = {
	account: argv.email_account || 'your email address like : 1204788939@qq.com',
...
exports.INFO = {
	...
	powered: ['react', 'Nodejs', 'MongoDB', 'Eggjs', 'Nginx'],
};